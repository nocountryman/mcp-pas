...
class TestLearning:
    ...
    async def test_parse_terminal_output_success(self, db_connection):
        ...
        from pas.server import start_reasoning_session, parse_terminal_output
    ...
    async def test_parse_terminal_output_auto_record(self, db_connection):
        ...
        from pas.server import start_reasoning_session, store_expansion, parse_terminal_output
    ...
    async def test_get_calibration_stats(self, db_connection):
        ...
        from pas.server import get_calibration_stats
    ...
    async def test_refresh_law_weights(self, db_connection):
        ...
        from pas.server import refresh_law_weights
